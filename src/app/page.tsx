...
export default function Home() {
  return (
    ...
    <main className='absolute inset-8 flex justify-left items-center text-center md:w-auto sm:w-auto '>
   <div>
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap items-center text-center">
      <div className="p-4 md:w-1/2 w-full ">
        <div className="h-full bg-slate-600 p-8 rounded items-center text-center">
